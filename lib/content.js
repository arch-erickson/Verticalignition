...
export const hero = {
  ...
  scrollCue: "Scroll",
  imageLabel: "PLACEHOLDER: hero — rebranded storefront or interior, wide shot",
};
  ...
  audiences: [
    {
      ...
      note: "Years in business, a look that stopped keeping up",
      lead: true,
    },
    {
    ...
    { label: "First-time openings", note: "You've never done this. We've done it plenty." },
  ],
};
  ...
  steps: [
    {
      ...
      note:
        "We come to you. We look at what you've got, listen to what's not working, and tell you straight what it takes and what it costs.",
    },
    {
      n: "02",
      label: "Design",
      ...
      note:
        "You see the new brand and the new space together before anything gets built or printed. No surprises later, no guessing.",
    },
    {
      n: "03",
      label: "Build",
      ...
      note:
        "This is the part that eats people alive. We handle the contractors, the deliveries and the inspections. You get a weekly update instead of a headache.",
    },
    {
      n: "04",
      label: "Relaunch",
      ...
      note:
        "Website live, photos shot, signage up, socials running. Whether it's an opening or a reintroduction, the day is handled.",
    },
    {
      n: "05",
      label: "Grow",
