...
export const hero = {
  ...
  cta: { label: "Show us the space", href: "/contact" },
...
export const whoFor = {
  ...
  body:
    "You've been open for years. The food, the service, the work is good — but the space, the logo and the website are telling an older story than the one you're living now. That's the job we do best. New openings too, and we love those, but the rebrand is where we do the most good.",
  audiences: [
    {
...
export const caseStudies = [
  ...
  },
  {
    ...
    challenge:
      "A team doing high-end work in a space that didn't reflect the level of it.",
    delivered:
