...
export const hero = {
  ...
  scrollCue: "Scroll",
  // Drop a file in /public and set this path to swap the placeholder for a
  // real photo — e.g. "/hero-interior.jpg". Leave empty to keep the
  // labelled placeholder inside the glass frame.
  image: "",
  imageAlt:
    "Interior of a fashion store designed and built by Vertical Ignition",
