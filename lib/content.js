...
export const hero = {
  ...
  // real photo. Leave empty to fall back to the labelled placeholder.
  // Source PNG lives in /Assets; this is the optimised JPEG.
  image: "/hero.jpg",
  imageWidth: 2048,
  imageHeight: 1056,
  imageAlt:
    "Dining room of a restaurant rebranded by Vertical Ignition — dark oak panelling, leather banquettes and a suspended floral installation",
